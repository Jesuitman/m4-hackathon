...
function App() {
  ...
  const updateColors = () => {
    setColors({
      ...
      buttonColorSB3: getRandoColor(),
      buttonColorSB4: getRandoColor(),
      buttonColorSB5: getRandoColor(),
      buttonColorSB6: getRandoColor(),
    });
  };
  ...
  return (
    <main className='App'  onClick={handleFirstClick}>
      ...
      <Form fetchReviews={fetchReviews} newState={newState} setFontSize={setFontSize} fontSize={fontSize} colors={colors} />
      {
        showMessage && (
          <div className="card-delaware">
            ...
            <button type="submit" style={{backgroundColor: colors.buttonColorSB4, color: colors.buttonColorSB5}} onClick={cardTwoFunction}>Click to Remove this Card</button>
          </div>
        )
      }
      {
        cardTwo && (
          <div className="card-two">
            ...
            <button type="submit" style={{backgroundColor: colors.buttonColorSB5, color: colors.buttonColorSB6}} onClick={cardThreeFunction}>Click to Remove this Card</button>
          </div>
        )
      }
      {
        cardThree && (
          <div className="card-bats">
            ...
            <button type="submit" style={{backgroundColor: colors.buttonColorSB2, color: colors.buttonColorSB4}}onClick={cardFourFunction}>Click to Remove this Card</button>
      ...
      {cardFour && (
       <div className="card-heat">
         ...
         <button type="submit" style={{backgroundColor: colors.buttonColorSB3, color: colors.buttonColorSB6}} onClick={fetchReviews}>Get Your Review!</button>
       </div>
     )}
